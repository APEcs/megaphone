...
# Webapp modules
use Megaphone::AppUser;
use Megaphone::BlockSelector;
use Megaphone::System;
...
my $app = Webperl::Application -> new(appuser        => Megaphone::AppUser -> new(),
                                      system         => Megaphone::System -> new(),
                                      block_selector => Megaphone::BlockSelector -> new())
