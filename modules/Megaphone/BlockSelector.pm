...
## @class
# Select the appropriate block to render a page based on an Megaphone URL.
# This allows a url of the form /block/item/path/?args to be parsed into
# something the Megaphone classes can use to render pages properly, and
# select the appropriate block for the current request.
package Megaphone::BlockSelector;
...
# data, allowing Megaphone paths to be passed to the rest of the code without
